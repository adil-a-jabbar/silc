...
case 16:
#line 83 "yaccfile.y"
	{currGSymbol = setGentry(yystack.l_mark[-7].no->varName); if (type != currGSymbol->type) {yyerror ("invalid type for function\n");} yystack.l_mark[-1].no->nodeType = FUN_DEF; checkNameEquivalence (yystack.l_mark[-7].no->varName); FILE* filePointer = fopen ("executable.xsm", "a"); codeGen (yystack.l_mark[-1].no, filePointer); fclose (filePointer); paramList=NULL; paramListTail=NULL; Lhead=NULL; Ltail=NULL; currPBinding=1; currNBinding=-1;}
#line 1528 "y.tab.c"
break;
case 17:
#line 85 "yaccfile.y"
...
case 34:
#line 111 "yaccfile.y"
	{yystack.l_mark[-1].no->nodeType = MAIN_FUN; FILE* filePointer = fopen ("executable.xsm", "a"); codeGen (yystack.l_mark[-1].no, filePointer); fclose (filePointer); paramList=NULL; paramListTail=NULL; Lhead=NULL; Ltail=NULL; currPBinding=1; currNBinding=-1;}
#line 1613 "y.tab.c"
break;
case 35:
#line 113 "yaccfile.y"
