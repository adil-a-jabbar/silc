...
struct Gsymbol * Ginstall (char * name, struct Typetable * type, int size, struct Paramstruct * paramlist){
...
struct Lsymbol * Linstall (char * name, struct Typetable * type, int binding){
