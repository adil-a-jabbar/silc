...
%type <no> expr NUM program END Slist Stmt InputStmt OutputStmt AsgStmt IfStmt WhileStmt BreakStmt ContinueStmt ID
%token NUM PLUS MINUS MUL DIV END SPACE NEWLINE ID ASSG READ WRITE START COLON LT LE GT GE EQ NE IF THEN ELSE ENDIF WHILE ENDWHILE DO BREAK CONT
